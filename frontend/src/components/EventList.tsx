    ...
    <div className="overflow-hidden rounded-lg border border-gray-200 shadow-sm">
      <table className="min-w-full divide-y divide-gray-200 bg-white text-sm">
        <thead className="bg-gray-50">
          <tr>
            <th className="px-6 py-3 text-left font-semibold text-gray-900">Name Event</th>
            <th className="px-6 py-3 text-left font-semibold text-gray-900">Description</th>
            <th className="px-6 py-3 text-left font-semibold text-gray-900">Start Time</th>
            <th className="px-6 py-3 text-left font-semibold text-gray-900">End Time</th>
        ...
        <tbody className="divide-y divide-gray-100">
          {events.map((e) => (
            <tr key={e.id} className="hover:bg-gray-50 transition-colors">
              <td className="px-6 py-4 text-gray-700 font-medium">{e.name_event}</td>
              <td className="px-6 py-4 text-gray-600">{e.description}</td>
              <td className="px-6 py-4 text-gray-600 font-mono">{e.start_time}</td>
              <td className="px-6 py-4 text-gray-600 font-mono">{e.end_time}</td>
              <td className="px-6 py-4 text-gray-600 font-mono">{e.date}</td>
